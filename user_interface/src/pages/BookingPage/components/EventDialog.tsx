...
const EventDialog: React.FC<EventDialogProps> = ({ isOpen, event, setIsOpen, setEditEventOpen, isEditEventOpen }) => {
  ...
  const deleteAppointment = async (id: number) => {
    return await (await BookingService.deleteBooking(id.toString())).data;
  }
